      ...
      <div className="columns-4 gap-4 space-y-4">
        {
          images.map((image, index) =>{
            return <div key={index}>
              <div className="relative group overflow-hidden cursor-pointer transition-transform" onClick={()=> setSelectedImage(image)}>
                <div className="absolute inset-0 bg-black opacity-0 transition-opacity duration-300 group-hover:opacity-20 rounded">
