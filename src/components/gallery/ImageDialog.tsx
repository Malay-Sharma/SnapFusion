    ...
    <Sheet open={true} onOpenChange={onClose}>
        <SheetContent className='max-w-full sm:max-w-xl w-full'>
            ...
            <div className="relative w-fit h-fit">
                <Image src={image.url || ""} alt={image.prompt || ""} width={image.width || 0} height={image.height || 0} className="w-full h-auto flex mb-3 rounded" />
            ...
            <div className='flex flex-wrap gap-3 mb-32'>
                ...
                <Badge variant={"secondary"} className='rounded-full border border-primary/30 px-4 py-2 text-sm font-normal'>
                <span className='text-primary uppercase mr-2 font-semibold'>No. of Inference Steps:</span>
                ...
                <Badge variant={"secondary"} className='rounded-full border border-primary/30 px-4 py-2 text-sm font-normal'>
                <span className='text-primary uppercase mr-2 font-semibold'>Created On:</span>
